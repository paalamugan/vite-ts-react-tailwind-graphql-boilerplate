...
export type FilmItemFragmentFragment = {
  __typename?: 'Film';
  title?: string | null;
...
export const FilmItemFragmentFragmentDoc = new TypedDocumentString(
  `
...
) as unknown as TypedDocumentString<FilmItemFragmentFragment, unknown>;
